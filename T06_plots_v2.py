...
forcing_file = 'BC/PRBS_100_10000_S1_0.00200000.U' if mode=="outlet" else 'BC/PRBS_100_10000_S0_0.00200000.U'

dir = sys.argv[1] if len(sys.argv) > 1 else 'TEMPORAL_T06_R0.0_OUTLET'
print('using dir:', dir)
...
ax.set_ylabel('Magnitude (sqrt(PSD))')
...
ax.plot(f[args], vfitIN, color='k', linestyle='dashed', linewidth=3, 
        label=rf'$\frac{{-1}}{{1+i \omega \tau}}$' + f', $\\sigma = {2 / c / tau_IN:.8f}$')
